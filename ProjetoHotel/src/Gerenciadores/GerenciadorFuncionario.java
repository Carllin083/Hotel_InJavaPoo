...
public class GerenciadorFuncionario {
	...
	public void cadastrarFuncionario(String nome, String cpf, String cargo, String turno, double salario) {
		...
		listaFuncionarios.add(new Funcionario(nome, cpf, cargo, turno, salario));
